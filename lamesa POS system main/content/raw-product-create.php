                        ...
                        <form action="code.php" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-1">
                                    ...
                                    <select required name="product_id" class="form-select" id="product_id">
                                ...
                                <div class="col-2">
                                    ...
                                    <input type="text" name="raw_material_name" placeholder="Raw Material Name" required class="form-control">
                                </div>

                                <div class="col-4">
                                    <label>Quantity *</label>
                                    <input type="text" name="raw_material_quantity" placeholder="Quantity" required class="form-control">
                                </div>

                                <div class="col-5">
                                    <label>Date Delivered *</label>
                                    <input type="date" name="date_delivered" required class="form-control">
                                </div>
                                ...
                                <div class="col-8">
                                    ...
                                    <button type="submit" class="btn2" name="saveRawProduct">Save<i class="fa-solid fa-plus"></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
